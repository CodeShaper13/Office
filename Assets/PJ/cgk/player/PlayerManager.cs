...
public class PlayerManager  : MonoBehaviour {
    ...
    private RectTransform[] uiLocations;
    ...
    private void Awake() {
        this.playerUIs = new PlayerUI[this.maxPlayers];
    ...
    public T createPlayer<T>(Vector3 playerStartPos) where T : IPlayer {
        ...
        T newPlayer = (T)GameObject.Instantiate(this.playerPrefab).GetComponent<IPlayer>();
    ...
    public void removePlayer(IPlayer player) {
        ...
        if(this.splitScreen) {
            ...
            // Destroy the UI.
            GameObject.Destroy(this.playerUIs[id]);
